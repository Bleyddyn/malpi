...
def train(env, options):
    ...
    good_list = [
        ...
        [0.9532736609529558, 0.04909485782654801, 0.0037059114585797403, 0.9999888214414374, 0.006857253207473699, 103.44, 5000.0],
        [0.9523529570849981, 0.06803951761287354, 0.0009482867027349048, 0.9966230153985275, 0.002508308017936049, 75.22, 5000.0],
        [0.9632821178323182, 0.09126594706684933, 0.003242916230345248, 0.9976888362189715, 0.006063571215407683, 103.83, 5000.0],
        [0.8143831972754272, 0.09826238724324965, 0.0010734671646720085, 0.999228508898421, 0.009825571596356544, 104.27, 5000.0],
        [0.8411117230764505, 0.04888208636074594, 0.08837342482106537, 0.9915819506184637, 0.002568936055777972, 130.6, 5000.0]
                ]
...
#    bounds = np.array( [ [10, 50], [1,50], [100,1000], [0.1,1.0], [0.1,1.0], [0.99,1.0], [0.0001,0.1], [0.0001,0.1], [0.99,1.0], [0.9,1.0], [0.0,1.0], [0.0005,0.01] ] )
    ...
    do_uniform = False
    do_normal = False
    next_sample = np.array( [0.9532736609529558, 0.04909485782654801, 0.0037059114585797403, 0.9999888214414374, 0.006857253207473699 ] )
    params_for_pg = [0.589395, 0.0621287, 0.0, 0.99970608, 0.0078707, 200., 690.]
    #next_sample = np.array( params_for_pg )
    scores = []
