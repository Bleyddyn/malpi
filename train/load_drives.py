...
class DriveDataGenerator(Sequence):
    ...
    def __init__(self, filelist, image_size=(120,120), batch_size=32, shuffle=True, max_load=30000 ):
...
if __name__ == "__main__":
    ...
    gen = DriveDataGenerator(args.dirs, batch_size=32, shuffle=True, max_load=2000 )
