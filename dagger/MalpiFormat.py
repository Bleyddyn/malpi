...
def tests():
    ...
    try:
        d = MalpiFormat("NonExistantDrivePath_________")
    except IOError as ex:
    ...
    try:
        DriveFormat.registerFormat( "test_format", MalpiFormat )
    except Exception as exg:
    ...
    if MalpiFormat.canOpenFile( "test.drive" ):
        print( "Can open file test.drive: PASS" )
    else:
        print( "Can't open file test.drive: FAIL" )
